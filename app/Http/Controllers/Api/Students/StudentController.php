...
class StudentController extends Controller
{
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'blood_group' => 'nullable|string|max:10',
            'dob' => 'nullable|date',
            'birth_certificate_no' => 'sometimes|required|string|max:50',
            'fathers_name' => 'sometimes|required|string|max:255',
            'father_nid' => 'sometimes|required|string|max:50',
            'father_mobile' => 'sometimes|required|string|max:20',
            'mothers_name' => 'sometimes|required|string|max:255',
            'mother_nid' => 'sometimes|required|string|max:50',
            'mother_mobile' => 'nullable|string|max:20',
            'photo_path' => 'nullable|string|max:500',
            'present_address' => 'nullable|string',
            'permanent_address' => 'nullable|string',
    ...
    public function bulkRegister(Request $request): JsonResponse
    {
        ...
        $data = $request->validate([
            ...
            'students.*.birth_certificate_no' => 'nullable|string|max:50',
            'students.*.father_nid' => 'nullable|string|max:50',
            'students.*.mother_nid' => 'nullable|string|max:50',
        ...
        foreach ($data['students'] as $index => $studentData) {
            try {
                $student = Student::create([
                    ...
                    'birth_certificate_no' => $studentData['birth_certificate_no'] ?? null,
                    'father_nid' => $studentData['father_nid'] ?? null,
                    'mother_nid' => $studentData['mother_nid'] ?? null,
