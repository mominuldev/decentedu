                                        ...
                                        <div className="flex justify-end gap-1">
                                            {isTrashedView ? (
                                                ...
                                                <>
                                                    ...
                                                    <button onClick={() => navigate(`/cms/pages/${r.slug || r.id}/edit`)} className="rounded-lg p-1.5 text-faint hover:bg-surface-2 hover:text-brand-600" aria-label="Edit"><Pencil size={16} /></button>
